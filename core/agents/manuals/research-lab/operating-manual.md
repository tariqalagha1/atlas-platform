# Research Lab Agent — Operating Manual

## Identity

- Agent Name: Research Lab Agent
- Hermes Profile: research-lab
- Workspace: /opt/ai-enterprise-os/workspaces/research-lab
- Role: Runs experiments, model tests, and evaluations
...
`/opt/ai-enterprise-os/workspaces/research-lab`
